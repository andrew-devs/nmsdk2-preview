...
extern SecureElementNvmData_t lorawan_se;
static SecureElementNvmData_t* SeNvm;

static void SecureElementSetDeviceEUI()
{
    uint8_t isEmpty = true;
    for (int i = 0; i < SE_EUI_SIZE; i++)
    {
        if (lorawan_se.DevEui[i] != 0x00)
        {
            isEmpty = false;
            break;
        }
    ...
    if (isEmpty)
    {
        ...
        lorawan_se.DevEui[0] = (uint8_t)(id.sMcuCtrlDevice.ui32ChipID0);
        lorawan_se.DevEui[1] = (uint8_t)(id.sMcuCtrlDevice.ui32ChipID0 >> 8);
        lorawan_se.DevEui[2] = (uint8_t)(id.sMcuCtrlDevice.ui32ChipID0 >> 16);
        lorawan_se.DevEui[3] = (uint8_t)(id.sMcuCtrlDevice.ui32ChipID0 >> 24);
        lorawan_se.DevEui[4] = (uint8_t)(id.sMcuCtrlDevice.ui32ChipID1);
        lorawan_se.DevEui[5] = (uint8_t)(id.sMcuCtrlDevice.ui32ChipID1 >> 8);
        lorawan_se.DevEui[6] = (uint8_t)(id.sMcuCtrlDevice.ui32ChipID1 >> 16);
        lorawan_se.DevEui[7] = (uint8_t)(id.sMcuCtrlDevice.ui32ChipID1 >> 24);
    }
}
...
SecureElementStatus_t SecureElementInit( SecureElementNvmData_t* nvm )
{
    ...
    // If DeviceEUI is empty, then populate with the processor ID.
    SecureElementSetDeviceEUI();

    // Initialize data
    memcpy1( ( uint8_t* )SeNvm, ( uint8_t* )&lorawan_se, sizeof( lorawan_se ) );
